			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('Invlices/index') }}">الفواتير </a></li>

							<li><a class="slide-item" href="{{route('Invoices/Invoice_Paid')}}">الفواتير المدفوعة</a></li>
							<li><a class="slide-item" href="{{route('Invoices/Invoice_UnPaid')}}">الفواتير الغير مدفوعة</a></li>
							<li><a class="slide-item" href="{{route('Invoices/Invoice_Partial')}}">الفواتير المدفوعة جزئياً</a></li>
							<li><a class="slide-item" href="{{route('invoiceArchive/index')}}">  الأرشيف</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('InvoicesReport/index')}}">تقارير الفواتير</a></li>
							<li><a class="slide-item" href="{{ route('CustomerReport/index') }}">تقارير العملاء</a></li>
