                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ route('InvoicesDetails/index',$invoice->id )}}">{{ $invoice->sections->section_name }}</a>
                                        </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{route('invoiceArchive/delete')}}" method="post">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{route('invoiceArchive/update')}}" method="post">
