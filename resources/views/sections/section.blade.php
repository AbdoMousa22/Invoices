							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example1" class="table key-buttons text-md-nowrap" data-page-length="10">
										...
										<tbody>
                                            @forelse($data_section as $data_section)

											<tr>
												<td> {{$id++}}</td>
												<td> {{$data_section->section_name}}</td>
												<td> {{$data_section->description}}</td>
												<td> {{$data_section->created_by}}</td>
                                                <td>

                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                    data-id="{{ $data_section->id }}" data-section_name="{{ $data_section->section_name }}"
                                                    data-description="{{ $data_section->description }}" data-toggle="modal" href="#exampleModal2"
                                                    title="تعديل"><i class="las la-pen">تعديل</i></a>

                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                       data-id="{{ $data_section->id }}" data-section_name="{{ $data_section->section_name }}" data-toggle="modal"
